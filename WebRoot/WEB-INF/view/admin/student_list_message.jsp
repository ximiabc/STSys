...
<body>
	<a href="adminaddstudent" class="btn btn-success"> <span
			...
			<tbody style="color: #000;"><!-- 表单体 -->
				<s:iterator value="pageBean.recordList" var="n" status="indexs">
					<tr>
						...
						<td>${account }</td>
						<td>${date }</td>
						<td><a href="adminupdatestudent?id=${id }" class="btn btn-warning btn-sm">
								<i class="glyphicon glyphicon-wrench"></i>
							</a>
                          	<a href="admindelStudent?id=${id }" onclick="return confirm('确认删除此学生？');" class="btn btn-default btn-sm">
				...
				<tr>
					<td colspan="9">
						<div class="pull-right">
							<nav>
							<ul class="pagination">
								<li><a href="adminliststudent?pageNum=0" aria-label="Previous">
								...
								<s:iterator begin="pageBean.beginPageIndex"
									...
									<li><c:if test="${pageBean.currentPage == pageNums }">
											...
											<a href="adminliststudent?pageNum=${pageNums }">${pageNums }</a>
										</c:if></li>
								</s:iterator>
								<li><a href="adminliststudent?pageNum=${pageBean.pageCount }"
